    ...
    <div className="h-full flex flex-col bg-background">
      ...
      <div className="flex-1 flex flex-col">
        {isLoading ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center p-8 border border-border/50 bg-muted/5">
            <div className="w-12 h-12 border border-foreground flex items-center justify-center mb-6">
